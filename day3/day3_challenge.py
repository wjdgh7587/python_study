...
def add_to_dict(dic={}, word=0, story=0):
	
	if type(dic) != dict:
		print(f"You need to send a dictionary. You sent: {type(dic)}")
	
	else:
		if type(word) == str and story == 0:
			print("You need to send a word and a definition")
		else:
			if word not in my_english_dict:
				my_english_dict[word] = story
				print(f"{word} has been added.")
			else:
				print(f"{word} is already on the dictionary. Won't add.")	
		
def get_from_dict(dic={}, word=0, story=0):
	if type(dic) != dict:
			print(f"You need to send a dictionary. You sent: {type(dic)}")
...
def update_word(dic={}, word=0, story=0):
	if type(dic) != dict:
		print(f"You need to send a dictionary. You sent: {type(dic)}")
	else:
		if type(word) == str and story == 0:
			...
			if word not in my_english_dict and story not in my_english_dict:
...
def delete_from_dict(dic={}, word=0, story=0):
	if type(dic) != dict:
			print(f"You need to send a dictionary. You sent: {type(dic)}")
	else:
		if type(word) != str and type(story) != str:
